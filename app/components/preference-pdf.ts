...
const buildProgramCard = (program: ExportProgram, index: number) => `
  <article class="program-card">
    ...
    <div class="detail-grid two-column">
      ...
      ${detailItem("2025 başarı sırası", formatNumber(program.rank2025), "detail-accent")}
    </div>
    ...
    <div class="detail-grid three-column">
      ...
      ${detailItem("2026 yeni kontenjan", formatNumber(program.quota2026), "detail-accent")}
    </div>
...
<body>
  ...
  <main class="report">
    ...
    <footer class="report-notes">
      <p><strong>Veri notu:</strong> Başarı sıralamaları 2024 ve 2025 yerleştirme verilerini; kontenjanlar 2024, 2025 ve yeni 2026 sayılarını gösterir. “-” işareti veri bulunmadığını belirtir.</p>
