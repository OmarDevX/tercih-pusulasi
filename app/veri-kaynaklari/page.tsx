...
const sources = [
  ["YÖK Atlas", "Program adları, üniversiteler, fakülteler ve 2024–2025 son yerleşen başarı sıralamaları.", "https://yokatlas.yok.gov.tr/"],
  ...
  return (
    <main className="seo-page">
      ...
      <div className="seo-content shell prose-page">
        ...
        <section><h2>Güncellik</h2><p>Veriler sürüm bazlı yerel dosyalarda tutulur. Bir kaynak güncellendiğinde program kodu ve normalize edilmiş üniversite adıyla yeniden eşleştirilir. Sayfalardaki yıl etiketi, göstergenin hangi döneme ait olduğunu belirtir.</p></section>
