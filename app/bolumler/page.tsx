...
export const metadata: Metadata = {
  title: "Tüm Üniversite Bölümleri ve 2026 Sıralamaları",
  description: `${SUBJECT_GROUPS.length} bölümün 2026 başarı sıralamalarına, 2026 kontenjanlarına ve üniversite seçeneklerine ulaşın.`,
...
export default function SubjectsDirectoryPage() {
  ...
  return (
    <main className="seo-page">
      ...
      <SeoHeader eyebrow={`${sorted.length} bölüm başlığı`} title="Tüm üniversite bölümleri" description="A'dan Z'ye bölüm sayfaları: 2026 son yerleşen sıralamaları, 2026 kontenjanları ve program seçenekleri." />
