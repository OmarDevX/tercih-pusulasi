...
export const metadata: Metadata = {
  title: "YKS Tercih Pusulası: 2026 Sıralamaları ve Kontenjanları",
  description:
    "21.493 üniversite programını 2026 başarı sıralamaları, 2026 kontenjanları, URAP, THE ve QS verileriyle karşılaştırın.",
      ...
      <JsonLd
        data={[
          ...
          },
          {
            ...
            description:
              "2024–2026 son yerleşen başarı sıralamaları, 2024–2026 kontenjanları ve üniversite akademik sıralamaları.",
      ...
      <section className="seo-discovery" aria-labelledby="seo-discovery-title">
        <div className="shell">
          <div className="seo-section-heading">
            ...
            <p>
              Arama sonuçlarının yanında her bölüm ve üniversite için 2026 sıralaması,
