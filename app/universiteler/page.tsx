...
export const metadata: Metadata = {
  ...
  description: `${UNIVERSITY_NAMES.length} üniversitenin programlarını, 2025 başarı sıralamalarını, 2026 kontenjanlarını ve akademik göstergelerini inceleyin.`,
...
export default function UniversitiesDirectoryPage() {
  ...
  return (
    <main className="seo-page">
      ...
      <SeoHeader eyebrow={`${sorted.length} üniversite`} title="Tüm üniversiteler" description="Üniversite profilleri, program listeleri, 2025 sıralamaları, 2026 kontenjanları, URAP, THE ve QS göstergeleri." />
