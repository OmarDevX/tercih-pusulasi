...
export const metadata: Metadata = {
  ...
  title: {
    default: "YKS Tercih Pusulası: 2025 Sıralamaları ve 2026 Kontenjanları",
    template: `%s | ${SITE_NAME}`,
  },
  description:
    "Üniversite programlarını 2025 başarı sıralamaları, 2026 kontenjanları, URAP, THE, QS ve araştırma verileriyle karşılaştırın.",
  ...
  openGraph: {
    ...
    description:
      "2025 başarı sıralamaları, 2026 kontenjanları ve üniversite akademik verileri tek yerde.",
    url: "/",
  ...
  twitter: {
    ...
    title: "YKS Tercih Pusulası",
    description: "2025 sıralamaları ve 2026 üniversite kontenjanları.",
    images: ["/og-image.png"],
  },
  icons: {
    icon: "/favicon.svg",
